  ...
  return (
    <div className="contacts-container">
      ...
      <div className="location-info">
        <h2>Ubicación</h2>
        <div className="location">C. 111 315, Santa Rosa, 97279 Mérida, Yuc.</div>
      </div>
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p style={{ color: '#000' }}>Thank you for contacting us. One of our EVOCARS advisors will get in touch with you shortly.</p>
          </div>
        </div>
      )}
    </div>
